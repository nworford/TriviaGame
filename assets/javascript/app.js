...
function game_over() { 
    ...
    if( correct == 12) {
        score += "Your knowledge of the great Vincent Van Gogh is SUPERB!";
    }
    else if( correct >= 8) {
        score += "Your knowledge of the great Vincent Van Gogh is ABOVE AVERAGE!";
    }
    else if( correct >= 4) {
        score += "Your knowledge of the great Vincent Van Gogh is AVERAGE!";
    }
    else if( correct < 4) {
        score += "Your knowledge of the great Vincent Van Gogh is BELOW AVERAGE!";
    }
    else if( correct == 0) {
        score += "Your knowledge of the great Vincent Van Gogh is NIL!";
    }
