...
function game_over() { 
	...
	$("#gif_box").hide();
	$("#starry_night").show();
    var score = "You answered " + correct + " questions correctly and " + incorrect + " incorrectly! ";
    if( correct == 12) {
